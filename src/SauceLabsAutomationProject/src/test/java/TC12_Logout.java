...
public class TC12_Logout extends DriverFactory{
    ...
    public void logout() throws Throwable {
        ...
        yourCart.validateMenuBtnDisplayed();
        yourCart.clickMenuBth();
        yourCart.validateLogoutBtnDisplayed();
        yourCart.clickLogoutBtn();
    }
}