...
public class TC05_ValidateEditAccontInformationPage extends DriverFactory{
    ...
    Login loginPage;
    Account accountPage;
    EditAccountDetails editAccountDetailsPage;
    ...
    @Test
    public void editAccountInformation() throws Throwable {
